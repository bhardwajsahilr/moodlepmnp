...
export function ManagerParticipantsPage() {
  ...
  return (
    <DashboardLayout role="training_manager" title="Participants" subtitle="All imported participants and their training module assignments">
        ...
        {!loading && participants.length === 0 && (
          <div className="text-center py-14 border border-dashed border-gray-200 rounded-xl mb-4">
            ...
            <div className="flex gap-2 justify-center">
              <Button icon={<Upload className="w-4 h-4" />} variant="secondary" size="sm" onClick={() => setCsvOpen(true)}>Import CSV</Button>
              <Link to="/manager/participants/add"><Button icon={<Plus className="w-4 h-4" />} size="sm">Add Participant</Button></Link>
            </div>
          </div>
        )}
